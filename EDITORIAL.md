...
7. Música está ativa para pop, indie, rock, rap e derivações com relevância editorial e repercussão verificável. Consulte `config.js` para os recortes mais recentes. A lista vazia de artistas significa seleção aberta dentro desses gêneros. Mantenha até 5 matérias, pelo menos 2 ligadas diretamente ao Brasil, priorizando artistas, bandas e eventos da Bahia quando houver fontes confirmadas; busque uma pauta baiana e outra brasileira sempre que possível, sem inventar conteúdo para completar a seleção. Cubra lançamentos, reportagens, shows e festivais e adicione datas confirmadas ao calendário. Não reproduza letras nem alegue que uma notícia é a mais pedida sem dados. Novas preferências do proprietário refinam essa base.
